...
Version:        2024.3.7
Release:        1
Summary:        Rider Professional repackaged for RPM based systems
...
## rider-pro-jbr
%package        jbr
Summary:        Rider Professional - Java Runtime
Requires:       %{name} = %{version}-%{release}
AutoReqProv:    no

%description    jbr
Provides JetBrain's Java Runtime for Rider Professional
