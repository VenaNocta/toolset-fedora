...
Version:        2024.3.5
Release:        1
Summary:        CLion Professional repackaged for RPM based systems
...
## clion-pro-jbr
%package        jbr
Summary:        CLion Professional - Java Runtime
Requires:       %{name} = %{version}-%{release}
AutoReqProv:    no

%description    jbr
Provides JetBrain's Java Runtime for CLion Professional
