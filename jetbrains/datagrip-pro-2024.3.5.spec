...
Version:        2024.3.5
Release:        1
Summary:        DataGrip Professional repackaged for RPM based systems
...
%description
Provides datagrip-pro


## datagrip-pro-jbr
%package        jbr
Summary:        DataGrip Professional - Java Runtime
Requires:       %{name} = %{version}-%{release}
AutoReqProv:    no

%description    jbr
Provides JetBrain's Java Runtime for DataGrip Professional
