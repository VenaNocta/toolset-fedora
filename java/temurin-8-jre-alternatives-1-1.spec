...
%global isJdk 0
Name:           temurin-%{java_version}-jre-alternatives
Version:        1
Release:        1
Summary:        Java Alternatives for Java Temurin %{java_version}

License:        https://www.apache.org/licenses/LICENSE-2.0
URL:            https://github.com/VenaNocta/toolset-fedora/java
BuildRequires:  ( coreutils or coreutils-single )
Requires:       temurin-%{java_version}-jre
...
%description
Provides Alternatives paths for Java Temurin %{java_version}

###############################################################################

%global priority               1081
%global compatiblename         temurin-%{java_version}-jre
%global java_version_full 1.%{java_version}.0
...
alternatives --install %{_jvmdir}/jre-%{java_version_full}-%{origin} $key %{_jvmdir}/%{sdkdir -- %{?1}} $PRIORITY  --family %{family}
%{set_if_needed_alternatives $key %{family}}
}
...
%define postun_headless() %{expand:
  ...
  %{save_and_remove_alternatives  jre_%{java_version_full}_%{origin} %{_jvmdir}/%{sdkdir -- %{?1}} $post_state %{family}}
}
