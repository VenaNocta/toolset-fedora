...
Version:        2024.3.5
Release:        1
Summary:        IntelliJ Professional repackaged for RPM based systems
...
%description
Provides intellij-pro


## intellij-pro-jbr
%package        jbr
Summary:        IntelliJ Professional - Java Runtime
Requires:       %{name} = %{version}-%{release}
AutoReqProv:    no

%description    jbr
Provides JetBrain's Java Runtime for IntelliJ Professional
